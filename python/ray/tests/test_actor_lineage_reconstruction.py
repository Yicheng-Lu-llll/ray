...
def test_del_actor_destroys_actor_and_releases_name(
    ...
    # Immediate del right after creation (before the actor is ever used). This
    # is end-to-end coverage of the earliest deletion timing; the two owner-side
    # branches (callback installed before vs. after the ref is gone) are pinned
    # deterministically by C++ unit tests in actor_task_submitter_test.cc.
    early = Actor.remote()
